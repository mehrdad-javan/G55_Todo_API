...
import se.lexicon.todo_api.service.impl.TodoServiceImpl;
...
public class TodoServiceTest {
    ...
    @BeforeEach
    void setUp() {
        person = new Person(TEST_PERSON_ID, "John Doe", "john@example.com", null);
    ...
    void testFindByPersonId() {
        // Arrange
        when(todoRepository.findByPersonId(TEST_PERSON_ID)).thenReturn(List.of(todo));
        ...
        assertEquals(TEST_TITLE, result.get(0).title());
        verify(todoRepository).findByPersonId(TEST_PERSON_ID);
    }
